"""Sensor for calculated battery kWh remaining from SoC and nameplate capacity registers."""
...
class ModbusBatteryKwhRemainingSensorDescription(SensorEntityDescription, EntityFactory):  # type: ignore[misc]
    """Description for a sensor which calculates remaining kWh from SoC and capacity registers."""
    ...
    def create_entity_if_supported(
        ...
        return ModbusBatteryKwhRemainingSensor(
...
class ModbusBatteryKwhRemainingSensor(ModbusEntityMixin, SensorEntity):
    """Remaining battery energy derived from SoC % and nameplate capacity registers."""

    def __init__(
        self,
        controller: EntityController,
        entity_description: ModbusBatteryKwhRemainingSensorDescription,
        soc_address: int,
